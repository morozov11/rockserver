...
pub use endpoints::{
    ...
    TRUSTED_PROXY_TOKEN_ENV, authenticate_control_ingress, router, router_with_repository,
    router_with_search_service, router_with_search_service_and_voice_timeout, router_with_services,
