...
RUN cargo build --locked --release --all-features --bin rockserver --bin account_cleanup --bin import_shared_catalog --bin import_full_catalog --bin backfill_embeddings
